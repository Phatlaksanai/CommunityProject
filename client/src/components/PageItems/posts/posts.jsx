...
const Posts = ({ userId, project, commuId, isDescCommu, isDescProject }) => {
  ...
  return (
    <div className="posts">
      ...
      {data?.pages?.map((page) =>
        page.map((post) => <Post post={post} key={post.post_id} commuId={commuId} isDescCommu={isDescCommu} isDescProject={isDescProject} />)
      )}
